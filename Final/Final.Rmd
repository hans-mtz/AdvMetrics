...
The code and the report can be found in my [github repo](https://github.com/hans-mtz/AdvMetrics/tree/master/Final)
...
```{r, out.width="50%", fig.show='hold', fig.cap="Figures 1 and 2 show the results for the value function, savings and labour on the grid of assets for periods 1 and 2, respectively."}
...
```{r, out.width=c("100%","50%"), fig.show='hold', fig.cap="Base case"}
